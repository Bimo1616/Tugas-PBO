...
class Dashboard:
    def __init__(self):
        ...
        self.admin_menu.add_command(label='Data Admin', command=lambda: self.new_window("Data Admin", FrmPersegi))
        self.admin_menu.add_command(label='Data Mahasiswa', command=lambda: self.new_window("Data Mahasiswa", FrmSegitiga))
        self.admin_menu.add_command(label='Data Dosen', command=lambda: self.new_window("Data Dosen", FrmLingkaran))

        # add menu items to menu Mahasiswa
        self.mahasiswa_menu.add_command(label='Data Admin', command=lambda: self.new_window("Data Admin", FrmPersegi))
        self.mahasiswa_menu.add_command(label='Data Mahasiswa', command=lambda: self.new_window("Data Mahasiswa", FrmSegitiga))
        self.mahasiswa_menu.add_command(label='Data Dosen', command=lambda: self.new_window("Data Dosen", FrmLingkaran))

        # add menu items to menu Dosen
        self.dosen_menu.add_command(label='Data Admin', command=lambda: self.new_window("Data Admin", FrmPersegi))
        self.dosen_menu.add_command(label='Data Mahasiswa', command=lambda: self.new_window("Data Mahasiswa", FrmSegitiga))
        self.dosen_menu.add_command(label='Data Dosen', command=lambda: self.new_window("Data Dosen", FrmLingkaran))
